...
@Composable
fun RamView(navController: NavController){
    Surface(
        modifier = Modifier.fillMaxSize(),
        color = Color.White
    ) { }
    RamContentView(navController)
}

@Composable
fun CarruselIamgenesRam() {
    val imagenes = listOf(
        R.drawable.ram1,
        R.drawable.ram2,
        R.drawable.ram3
...
@Composable
fun RamContentView(navController: NavController) {
